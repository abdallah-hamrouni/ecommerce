...
const onError = (res)=>{
  ...
  return (
    <GoogleOAuthProvider clientId="52663610326-hs533k1oi51kcbeujhh3rnm1jobv0209.apps.googleusercontent.com">
      <div>
          ...
          <div className="inner yo">
            <form onSubmit={handleLogin}>
              ...
              <div className="google-login-wrapper">
                <GoogleLogin
                  client_id="891812901211-2ahi02tm34vmtqta2599ipkpoc13ii6u.apps.googleusercontent.com"
                  onSuccess={onSuccess}
                  onError={onError}
                />
              </div>
